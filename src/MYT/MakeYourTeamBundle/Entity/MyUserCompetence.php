...
class MyUserCompetence{
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="MYT\MakeYourTeamBundle\Entity\MyUser", inversedBy="myuser_competences",cascade={"persist"})
     */
    private $user;

    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="MYT\MakeYourTeamBundle\Entity\Competence", inversedBy="myuser_competences",cascade={"persist"})
     */
    private $competence;
